...
//				.diskCacheExtraOptions(480, 800, null)
    ...
    public static DisplayImageOptions initOptions() {
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                // 设置图片在下载期间显示的图片
//                .showImageOnLoading(R.drawable.small_loadpic_empty_listpage)
//                // 设置图片Uri为空或是错误的时候显示的图片
//                .showImageOnFail(R.drawable.small_loadpic_empty_listpage)
//                .showImageForEmptyUri(R.drawable.small_loadpic_empty_listpage)
//                // 设置下载的图片是否缓存在内存中
//                .cacheInMemory(true)
//                // 设置下载的图片是否缓存在SD卡中
//                .cacheOnDisc(true)
